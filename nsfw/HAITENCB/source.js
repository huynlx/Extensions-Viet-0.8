...
var _Sources = (() => {
  ...
  // src/HAITENCB/HAITENCB.ts
  var HAITENCB_exports = {};
  __export(HAITENCB_exports, {
    HAITENCB: () => HAITENCB,
    HAITENCBInfo: () => HAITENCBInfo
  });
  ...
  // src/HAITENCB/HAITENCBParser.ts
  var Parser = class {
  ...
  // src/HAITENCB/HAITENCBSetting.ts
  var DEFAULT_BASE_URL = "https://2tencb.pro";
  ...
  return __toCommonJS(HAITENCB_exports);
})();
