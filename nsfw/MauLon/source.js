...
var _Sources = (() => {
  ...
  // src/MauLon/MauLon.ts
  var MauLon_exports = {};
  __export(MauLon_exports, {
    MauLon: () => MauLon,
    MauLonInfo: () => MauLonInfo
  });
    ...
    parseTags($) {
      ...
      $(".rank-math-html-sitemap__section").each((index, sectionEl) => {
        ...
        $section.find("ul.rank-math-html-sitemap__list li.rank-math-html-sitemap__item").each((_, liEl) => {
          ...
          const isDeletedAlbum = label.toLowerCase() === "album \u0111\xE3 x\xF3a" || id.includes("album-da-xoa");
  ...
  // src/MauLon/MauLonSetting.ts
  var DEFAULT_BASE_URL = "https://maulon.vip";
  ...
  var MauLon = class {
    ...
    async fetchMangaPage(realMangaId) {
    ...
    async getSearchResults(query, metadata) {
      ...
      const hasNextPageLink = $(".wp-pagenavi a.page, .wp-pagenavi a.larger").filter((_, el) => {
  ...
  return __toCommonJS(MauLon_exports);
})();
