...
var _Sources = (() => {
  ...
  // src/HentaiVNX/HentaiVNX.ts
  var HentaiVNX_exports = {};
  __export(HentaiVNX_exports, {
    HentaiVNX: () => HentaiVNX,
    HentaiVNXInfo: () => HentaiVNXInfo
  });
  ...
  // src/HentaiVNX/HentaiVNXParser.ts
  var Parser = class {
...
${rating}`;
    ...
    parseDate(dateStr) {
      ...
      if (lower.includes("ph\xFAt")) {
        now.setMinutes(now.getMinutes() - amount);
      } else if (lower.includes("gi\u1EDD")) {
        now.setHours(now.getHours() - amount);
      } else if (lower.includes("ng\xE0y")) {
        now.setDate(now.getDate() - amount);
      } else if (lower.includes("th\xE1ng")) {
    ...
    parseTags($) {
      ...
      const sortOptions = [
        ...
        { id: "sort=20", label: "Theo d\xF5i" },
        { id: "sort=25", label: "B\xECnh lu\u1EADn" },
  ...
  // src/HentaiVNX/HentaiVNXSetting.ts
  var DEFAULT_BASE_URL = "https://www.hentaivnx.com";
  ...
  // src/HentaiVNX/HentaiVNX.ts
  var DOMAIN = "https://www.hentaivnx.com/";
  var HentaiVNXInfo = {
    version: "1.0.0",
    name: "HentaiVNX",
    icon: "icon.png",
  ...
  return __toCommonJS(HentaiVNX_exports);
})();
