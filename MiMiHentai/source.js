...
var _Sources = (() => {
  ...
  // src/MiMiHentai/MiMiHentai.ts
  var MiMiHentai_exports = {};
  __export(MiMiHentai_exports, {
    MiMiHentai: () => MiMiHentai,
    MiMiHentaiInfo: () => MiMiHentaiInfo
  });
  ...
  // src/MiMiHentai/MiMiHentaiParser.ts
  var Parser = class {
    parseFeaturedSection(json) {
      const mangaList = [];
...
\u{1F441} L\u01B0\u1EE3t xem: ${views}`);
        ...
        $home('a[href*="/albums/"]').each((_, element) => {
          ...
          if (label) {
            albumTags.push(
              App.createTag({
                id: `album-${id}`,
                // Gắn prefix 'album-' để getSearchResults phân loại
        ...
        $genres('a[href*="/genres/"]').each((_, element) => {
          ...
          if (id && rawLabel) {
            ...
            genreTags.push(
              App.createTag({
                id: `genre-${id}`,
                // Gắn prefix 'genre-' để getSearchResults phân loại
  ...
  // src/MiMiHentai/MiMiHentaiSetting.ts
  var DEFAULT_BASE_URL = "https://mimihentai.moe";
  ...
  // src/MiMiHentai/MiMiHentai.ts
  var DOMAIN = "https://mimihentai.moe";
  var MiMiHentaiInfo = {
    version: "1.0.0",
    name: "MiMiHentai",
    icon: "icon.png",
  ...
  return __toCommonJS(MiMiHentai_exports);
})();
