...
var _Sources = (() => {
  ...
  // src/NudeBird/NudeBird.ts
  var NudeBird_exports = {};
  __export(NudeBird_exports, {
    NudeBird: () => NudeBird,
    NudeBirdInfo: () => NudeBirdInfo
  });
  ...
  // src/NudeBird/NudeBirdParser.ts
  var Parser = class {
    ...
    parseMangaDetails($, compositeId) {
      ...
      const descParts = [];
      if (views !== void 0 && viewsText) {
        descParts.push(`\u{1F441}\uFE0F L\u01B0\u1EE3t xem: ${viewsText.replace(/\D/g, "")}`);
      }
      const dateText = $(".post-info .thetime, .date.meta-item").first().text().trim();
      if (dateText) {
        descParts.push(`\u{1F4C5} Ng\xE0y \u0111\u0103ng: ${dateText}`);
      }
...
${decodeHTML(rawExcerpt).replace(/\s+/g, " ").trim()}`);
      ...
      const description = descParts.length > 0 ? descParts.join("\n") : "Kh\xF4ng c\xF3 m\xF4 t\u1EA3 chi ti\u1EBFt.";
  ...
  // src/NudeBird/NudeBirdSetting.ts
  var DEFAULT_BASE_URL = "https://nudebird.biz";
  ...
  var NudeBirdInfo = {
    ...
    description: "Extension that pulls manga from NudeBird.",
  ...
  var NudeBird = class {
    ...
    async getSearchResults(query, metadata) {
      ...
      return App.createPagedResults({
        results: manga,
        metadata: !isLast ? { page: page + 1 } : void 0
      });
    }
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      return App.createPagedResults({
        results: manga,
        metadata: !isLast ? { page: nextPageNum } : void 0
      });
    }
  ...
  return __toCommonJS(NudeBird_exports);
})();
