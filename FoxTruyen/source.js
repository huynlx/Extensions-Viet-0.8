...
var _Sources = (() => {
  ...
  var Parser = class {
    ...
    parseMangaDetails($, mangaId) {
      ...
      const author = $('.fx-meta__row:contains("T\xE1c gi\u1EA3") .fx-meta__val').text().trim() || "\u0110ang C\u1EADp Nh\u1EADt";
      const artist = author;
...
${statsLines}`.trim() : rawDesc;
    ...
    parseTags($) {
      ...
      const arrayRankings = [
        App.createTag({ id: "ranking.top-ngay", label: "Top Ng\xE0y" }),
        App.createTag({ id: "ranking.top-tuan", label: "Top Tu\u1EA7n" }),
        App.createTag({ id: "ranking.top-thang", label: "Top Th\xE1ng" }),
        App.createTag({ id: "ranking.top-binh-chon", label: "Top B\xECnh Ch\u1ECDn" })
      ];
      ...
      return [
        ...
        App.createTagSection({
          id: "3",
          label: "Tr\u1EA1ng Th\xE1i (Ch\u1EC9 ch\u1ECDn 1)",
