...
var _Sources = (() => {
  ...
  // src/NetTruyen/NetTruyen.ts
  var NetTruyen_exports = {};
  __export(NetTruyen_exports, {
    NetTruyen: () => NetTruyen,
    NetTruyenInfo: () => NetTruyenInfo
  });
  ...
  // src/NetTruyen/NetTruyenParser.ts
  var Parser2 = class {
    ...
    parseMangaDetails($, mangaId) {
      ...
      const rawDescription = $descEl.text().split("\n").map((line) => line.trim()).filter((line) => line.length > 0).join("\n\n");
    ...
    parseChapterList(data) {
      ...
      for (const item of data) {
        ...
        const formattedTime = item.updated_at ? format(parse(item.updated_at, "yyyy-MM-dd HH:mm:ss", /* @__PURE__ */ new Date()), "dd/MM/yyyy") : "";
    ...
    parseTags($) {
      ...
      const statusOptions = [
        ...
        { id: "status=2", label: decodeHTML("Ho\xE0n th\xE0nh") },
        { id: "status=1", label: decodeHTML("\u0110ang ti\u1EBFn h\xE0nh") }
      ];
      ...
      const sortOptions = [
        ...
        { id: "sort=11", label: decodeHTML("Top th\xE1ng") },
        { id: "sort=12", label: decodeHTML("Top tu\u1EA7n") },
        { id: "sort=13", label: decodeHTML("Top ng\xE0y") },
        { id: "sort=20", label: decodeHTML("Theo d\xF5i nhi\u1EC1u") },
        { id: "sort=25", label: decodeHTML("B\xECnh lu\u1EADn nhi\u1EC1u") },
      ...
      return [
        ...
        App.createTagSection({ id: "status", label: decodeHTML("Tr\u1EA1ng th\xE1i"), tags: statusTags }),
        App.createTagSection({ id: "sort", label: decodeHTML("X\u1EBFp h\u1EA1ng"), tags: sortTags })
      ];
    }
  };

  // src/NetTruyen/NetTruyenSetting.ts
  var DEFAULT_BASE_URL = "https://nettruyenviet10.com";
  ...
  // src/NetTruyen/NetTruyen.ts
  var DOMAIN = "https://nettruyenviet10.com";
  var NetTruyenInfo = {
    version: "1.0.1",
    name: "NetTruyen",
    icon: "icon.png",
  ...
  var NetTruyen = class {
    ...
    async getHomePageSections(sectionCallback) {
      ...
      const boysSection = App.createHomeSection({
        id: "boys",
        title: "Truy\u1EC7n D\xE0nh Cho Con Trai",
        containsMoreItems: true,
        type: import_types.HomeSectionType.singleRowNormal
      });
      const girlsSection = App.createHomeSection({
        id: "girls",
        title: "Truy\u1EC7n D\xE0nh Cho Con G\xE1i",
        containsMoreItems: true,
        type: import_types.HomeSectionType.singleRowNormal
      });
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      const sectionConfig = {
        hot: {
          ...
          parse: ($2) => this.parser.parseHotSection($2)
        },
        new_updated: {
  ...
  return __toCommonJS(NetTruyen_exports);
})();
