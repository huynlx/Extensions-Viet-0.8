...
import { Parser } from './NudeBirdParser';
import { domainSettings, getDomain, resetSettings } from './NudeBirdSetting';

const DOMAIN = 'https://nudebird.biz';

export const NudeBirdInfo: SourceInfo = {
    version: '1.0.0',
    name: 'NudeBird',
    icon: 'icon.png',
...
export class NudeBird implements SearchResultsProviding, MangaProviding, ChapterProviding, HomePageSectionsProviding {
