...
import { Parser } from './HAITENCBParser';
import { domainSettings, getDomain, resetSettings } from './HAITENCBSetting';

const DOMAIN = 'https://2tencb.pro';
...
export class HAITENCB implements SearchResultsProviding, MangaProviding, ChapterProviding, HomePageSectionsProviding {
