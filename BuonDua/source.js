...
var _Sources = (() => {
  ...
  // src/BuonDua/BuonDuaSetting.ts
  var DEFAULT_BASE_URL = "https://buondua.com";
  ...
  var BuonDua = class {
    ...
    async getSearchResults(query, metadata) {
      ...
      return App.createPagedResults({
        results: manga,
        metadata: lastPage ? void 0 : { page: page + 1 }
      });
    }
